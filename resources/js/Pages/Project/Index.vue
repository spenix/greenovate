...
import PageModal from '@/Pages/Project/Modal/IndexModal.vue';
...
const reloadDatatable = () => {
    table.value = $("#project-table").DataTable({
        processing: true,
        serverSide: true,
...
const setTableBtnAction = () => {
    $("#project-table").on("click", ".view-btn-option", (e) => {
        e.stopImmediatePropagation();
        var id = $(e.target).data("id");
        btnActionFunc(id, "VIEW");
    });
    $("#project-table").on("click", ".delete-btn-option", (e) => {
        e.stopImmediatePropagation();
        var id = $(e.target).data("id");
        btnActionFunc(id, "DELETE");
    });
    $("#project-table").on("click", ".edit-btn-option", (e) => {
        e.stopImmediatePropagation();
        var id = $(e.target).data("id");
...
const btnActionFunc = (id, action) => {
    ...
    modalAttrs.value.title = `${action} PROJECT`;
              ...
              <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 p-2 text-end">
                        <button type="button" class="btn btn-primary btn-sm" @click="btnActionFunc('', 'ADD')">Add Project</button>
                    </div>
