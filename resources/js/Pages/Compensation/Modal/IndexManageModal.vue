...
import PageModal from '@/Pages/Compensation/Modal/IndexCompensationSetupModal.vue';
...
const btnActionFunc = (id, action) => {
    ...
    if (["ADD", "EDIT", "VIEW"].includes(action)) {
        ...
        swal("Are you sure you want to delete data?", {
            ...
            switch (value) {
                case "catch":
                    router.delete(`${page?.url}/destroy_compensation/${id}`, {
                        onSuccess: () => {
                            swal(
                                "Success!",
                ...
                <div class="row">
                    <div class="col-4 mt-1">
                        <div class="row">
                            ...
                            <label for="compensation" class="text-muted">Compensation/Benefit:</label>
                            <input 
                                type="text" 
                                class="form-control" 
                                name="compensation" 
