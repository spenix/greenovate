...
import PageModal from '@/Pages/CodeLibrary/Department/Modal/IndexModal.vue';
...
const reloadDatatable = () => {
    table.value = $("#department-table").DataTable({
        processing: true,
        serverSide: true,
...
const setTableBtnAction = () => {
    $("#department-table").on("click", ".view-btn-option", (e) => {
        e.stopImmediatePropagation();
        var id = $(e.target).data("id");
        btnActionFunc(id, "VIEW");
    });
    $("#department-table").on("click", ".delete-btn-option", (e) => {
        e.stopImmediatePropagation();
        var id = $(e.target).data("id");
        btnActionFunc(id, "DELETE");
    });
    $("#department-table").on("click", ".edit-btn-option", (e) => {
        e.stopImmediatePropagation();
        var id = $(e.target).data("id");
...
const btnActionFunc = (id, action) => {
    ...
    modalAttrs.value.title = `${action} DEPARTMENT`;
