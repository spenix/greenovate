...
import PageModal from '@/Pages/CodeLibrary/Designation/Modal/IndexModal.vue';
...
const reloadDatatable = () => {
    table.value = $("#position-table").DataTable({
        processing: true,
        serverSide: true,
...
const setTableBtnAction = () => {
    $("#position-table").on("click", ".view-btn-option", (e) => {
        e.stopImmediatePropagation();
        var id = $(e.target).data("id");
        btnActionFunc(id, "VIEW");
    });
    $("#position-table").on("click", ".delete-btn-option", (e) => {
        e.stopImmediatePropagation();
        var id = $(e.target).data("id");
        btnActionFunc(id, "DELETE");
    });
    $("#position-table").on("click", ".edit-btn-option", (e) => {
        e.stopImmediatePropagation();
        var id = $(e.target).data("id");
...
const btnActionFunc = (id, action) => {
    ...
    modalAttrs.value.title = `${action} POSITION`;
    ...
    <main id="main" class="main">
        ...
        <nav>
            ...
            <li class="breadcrumb-item">
                <Link :href="route('departments')">Code Library</Link>
            </li>
              ...
              <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 p-2 text-end">
                        <button type="button" class="btn btn-primary btn-sm" @click="btnActionFunc('', 'ADD')">Add Position</button>
                    </div>
